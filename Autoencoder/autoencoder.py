...
# Create user item matrix for  movieLens dataset
...
class Autoencoder():
    ...
    # Create dataflow graph and feed the output of the encoder as an input to the decoder
    def createGraph(self):
        ...
        # Calculate MMSE (Masked Mean Squared Error)
